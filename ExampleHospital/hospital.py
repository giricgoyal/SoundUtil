...
# setShadowRefreshMode(ShadowRefreshMode.OnLightChange)
...
#torusModel.path = "hospital_all_modified-notable-bin.fbx"
...
torus.setScale(Vector3(0.3048, 0.3048, 0.3048)) # feet to meters conversion
...
everything.addChild(light2)
everything.addChild(light3)
